...
<hr class="w-75">	
  <!--FOOTER-->
    <div class="footer bg-light">
		<div class="container text-dark">
		 ...
		 <div class="col-sm-4">
			...
			<ul class="list-unstyled  px-5">
			 ...
			 <div class="col-sm-4 co"><h5 class="text-center">ABOUT US</h5> <hr>
		 <ul class="list-unstyled px-4 links">
	   
   
	 <div class="text-center">
		  <button type="button" class="btn btn-outline-info font-weight-bold w-20" data-toggle="collapse" data-target="#vission">VISSION</button>
	 </div>
	 ...
	 <div class="text-center">
		 <button type="button" class="btn btn-outline-info w-20 font-weight-bold" data-toggle="collapse" data-target="#mission">MISSION</button>
	 </div>
	 ...
	 <div class="text-center">
	   <button type="button" class="btn btn-outline-info w-20 font-weight-bold" data-toggle="collapse" data-target="#about">ABOUT WEB APP</button>
   </div>
