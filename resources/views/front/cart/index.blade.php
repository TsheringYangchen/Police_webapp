...
@section('content')
    ...
    <h2 class="mt-5"><i class="fa fa-shopping-cart"></i>  Cart</h2>
    <hr>

    @if ( Cart::instance('default')->count() > 0 )

        <h4 class="mt-5">{{ Cart::instance('default')->count() }} items(s) in Cart</h4>
        ...
        <div class="cart-items">
            ...
            <div class="row">
                ...
                <!-- Save for later  -->
                <div class="col-md-12">
                    <a href="/" class="btn btn-outline-dark">Check Menu For Today</a>
                    <a href="/checkout" class="btn btn-outline-info">Proceed to checkout</a>
                    <hr>
                </div>
                @else
                    <h3>There is not item in your Cart</h3>
                    <a href="/" class="btn btn-outline-dark">Check Menu</a>
                    <hr>
                @endif
